            ...
            <div class="form_container">
                <form id="signup_form" action="#">
                    ...
                    <div class="input_field_container">
                        <label for="zoney">Meal Plan Types</label>
                        <select name="zone" id="zone">
                            <option value="" selected>All</option>
                            <option value="Area 1">Veg</option>
                            <option value="Area 2">Non Veg</option>
                        </select>
                    ...
                    <div class="input_field_container">
                        ...
                        <br>
                        <fieldset>
                            <div class="c-flex ali-c gap-2">
                                <div class="plans r-flex ali-c jut-c gap-1" id="plans">
                                    <input class="plan_checkbox" type="checkbox" id="plan3" name="meal_plans"
                                        value="plan3">
                                    <label for="plan3" class="plan_info r-flex ali-c jut-sb gap-1">
                                        <div class="c-flex gap-05">
                                            <span class="w6">Plan 3</span>
                                            <span>Daily Lunch</span>
                                            <span>4 Roti, Sabji 1, Sabji 2</span>
                                            <span class="w4">This is a plan Description</span>
                                        </div>
                                ...
                                <div class="plans r-flex ali-c jut-c gap-1" id="plans">
                                    <input class="plan_checkbox" type="checkbox" id="plan4" name="meal_plans"
                                        value="plan4">
                                    <label for="plan4" class="plan_info r-flex ali-c jut-sb gap-1">
                                        <div class="c-flex gap-05">
                                            <span class="w6">Plan 4</span>
                                            <span>Daily Lunch</span>
                                            <span>4 Roti, Sabji 1, Sabji 2</span>
                                            <span class="w4">This is a plan Description</span>
                                        </div>
                    ...
                    <span class="input_desc pointer" onclick="contact_support()" id="manual_entry_desc">You
                        can Request Edits Via Contacting us on
                        <span style="text-decoration: underline;">Whatsapp</span></span>
                    ...
                    <div class="input_field_container">
                        <button type="submit" class="submit_btn r-flex ali-c jut-c gap-1">Add Selected Meal Plans
                            <iconify-icon icon="ooui:arrow-next-ltr" height="14"></iconify-icon></button>
                    </div>
                </form>
            </div>
        </section>
