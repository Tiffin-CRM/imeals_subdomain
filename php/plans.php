...
$meal_plans = [
    ...
    ["id" => "2", "type" => "NonVeg", "name" => "Plan 2", "items" => "4 Roti, Chicken Curry", "price" => 200, "frequency" => "Daily", "time" => "Lunch", "description" => "this is description"],
    ...
    ["id" => "4", "type" => "NonVeg", "name" => "Plan 4", "items" => "4 Roti, Chicken Curry", "price" => 400, "frequency" => "Daily", "time" => "Lunch", "description" => "this is description"],
